# Phase 3A EMG locked-profile acceptance — 2026-08-06

## Safety

UNO R4 WiFi alone; A0 was floating and explicitly uncalibrated. No EMG module, electrode, or
person was connected. The selected `EMG Module — Raw Output` profile was acknowledged as
...
| Profile | `wvu.bmeg420l.emg.raw.v1` 1.0.0; SHA-256 validated; acknowledgement true |
| Configuration | A0, 12 bit, 1000 samples/s |
| Host / board duration | 30.144 / 29.929 s |
...
Ignored outputs: `C:\Users\dd00055\AppData\Local\Temp\2\wvu_phase3a_emg_1786039983243\20260806_141305_Phase3A_emg_Run01.{bmeg,metadata.json,csv}`.
